...
fixed_pole_target = math.pi
flex_1_pole_target = math.pi
...
class EventCfg:
    ...
    randomize_rigid_body_mass_fixed = EventTerm(
        ...
        params={
            ...
            "mass_distribution_params": (-0.14, 0.04),
            "operation": "add",
    ...
    randomize_fixed_com_positions = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=["fixed_pole"]),
            "com_range": {"x": (0.0, 0.0), "y": (-0.04, 0.04), "z": (0.0, 0.0)},
        },
    )
