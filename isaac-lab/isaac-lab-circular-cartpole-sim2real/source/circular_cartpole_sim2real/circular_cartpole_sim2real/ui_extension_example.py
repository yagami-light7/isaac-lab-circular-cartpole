...
def some_public_function(x: int):
    print("[circular_cartpole_sim2real] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[circular_cartpole_sim2real] startup")
    ...
    def on_shutdown(self):
        print("[circular_cartpole_sim2real] shutdown")