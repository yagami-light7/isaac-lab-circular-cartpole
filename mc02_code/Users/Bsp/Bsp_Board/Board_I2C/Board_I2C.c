...
/* 此段ISR代码在现版本HAL库中不需手动编写 */
//void DMA1_Stream7_IRQHandler(void)
//{
//    if(DMA1->HISR & (1<<27))	// 检查传输完成中断标志
//    {
//        __HAL_DMA_CLEAR_FLAG(hi2c2.hdmatx, DMA_HISR_TCIF7);	// 清除传输完成标志
//        SET_BIT(hi2c2.Instance->CR1, I2C_CR1_STOP);	// 发送 I2C 停止信号
//    }
//}
